...
if [ -n "${PREBUILT:-}" ]; then
	...
	copied=false
	for pkg in alpymist-keys alpymist alpymistctl alpymist-install alpymist-menu alpymist-about alpymist-settings alpymist-wifi alpymist-auth alpymist-power alpymist-store alpymist-greeter alpymist-splash alpymist-desktop squint; do
		mkdir -p ~/ap/"$pkg"
