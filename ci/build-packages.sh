...
if [ -n "${PREBUILT:-}" ]; then
	...
	# changes.
	for pkg in alpymist-keys alpymistctl alpymist-install alpymist-menu alpymist-wifi alpymist-power alpymist-greeter alpymist-splash alpymist-desktop ghostty squint; do
		mkdir -p ~/ap/"$pkg"
