...
if [ -n "${PREBUILT:-}" ]; then
	...
	copied=false
	for pkg in alpymist-keys alpymist alpymistctl alpymist-install alpymist-menu alpymist-about alpymist-wifi alpymist-auth alpymist-splash alpymist-lock alpymist-power alpymist-settings alpymist-screensaver alpymist-saver-mountains alpymist-saver-starfield alpymist-store alpymist-greeter alpymist-desktop squint; do
		mkdir -p ~/ap/"$pkg"
