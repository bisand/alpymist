//! The mountains: Alpymist's own ranges, travelling past.
//!
...
///
/// The installer and the drawn wallpaper use this same value, and so do the
/// splash, the login screen and the lock when they have no picture to show:
/// these are the ranges Alpymist draws wherever it draws any.
